...
if __name__ == "__main__":
    ...
    try:
        ...
        #self.vector_store_id = "file-1nof5KQf1hGGWCsgdLfr3J"
        query = "What is P/E ratio of this year?"
        ...
        print("\nEND")
        # Clean up (comment this out if you want to keep the vector store)
        #if processor.vector_store_id:
        #    processor.delete_vector_store()
        #    print(f"Deleted vector store {processor.vector_store_id}")
